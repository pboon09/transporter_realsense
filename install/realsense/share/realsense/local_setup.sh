...
: ${AMENT_CURRENT_PREFIX:="/home/b/transporter_realsense/install/realsense"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/realsense/environment/pythonpath.sh"
